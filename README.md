...
Так как на github не заливаются файлы более 25м, - на обученные генераторы дал ссылки.
   ...
   2. Касательно второй работы,- здесь не так все однозначно. Хотел менее сазанных "имрессионистских устремлений" Рембрандта, но к сожалению из-за ограниченности времени, полного удовлетворения от результата не получил(
